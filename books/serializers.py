...
class KitobSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'category', 'tags', 'subcategory', 'ratings', 'average_rating', 'has_audio', 'has_pdf',
            'reservation_status',  # Read-only nested fields
...
class ReservationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ('user', 'author', 'img', 'place', 'c_at', 'reserved_from', 'reserved_until', 'approved_at',
                            'returned_at', 'first_name', 'last_name', 'status', 'c_at')
